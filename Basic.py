...
print(1.1 + 2.2)
# it will give a 'precesion' upto 15 numbers.
import decimal
...
# Advanced Numbers
# about a few more representations of numbers 
...
# is equal to 3**4 =3*3*3*3 = 81
pow(3,4)
# with 2 it is x**y but if we put 3 args (x**y) %z    
pow(3,4,5)
...
# A negative value will round to a power of 10. -1 rounds to the nearest 10,
#  -2 to the nearest 100, etc
...
str = 'how are you aryan'
# Changing case

# Capitalize first word in string
str.capitalize()
# uppercase every letter in a string
str.upper()
# lowercase every letter in string
str.lower()

# strings are immutable and only they return modified copies of the original string.
...
str.find('o')  
# returns the starting index position of the first occurence# return

# Formatting

str.center(20,'@')
# This allows to place string 'centered' between a provided string with a certain length.

print('hello\thi')
'hello\thi'.expandtabs()
# will expand tab notations \t into spaces.A tab space.

# "is" check methods

str = 'how are you aryan'

# whether str is alphanumeric
str.isalnum()

# is alpha
str.isalpha()

# str is lowercase then True
str.islower()

# all characters in str are whitespace.
str.isspace()

# if str is title,generally uppercase characters
str.istitle()

# str is uppercase then True
str.isupper()

# if ends with character,returns true
str.endswith('n')
...
str.partition('a')
# this will split and returns  front,separator and the back

#%%

# Advanced StringsSets
...
# Discard :Removes an element from a set if it is a member, not a member, do nothing.
set1 = {1,2,3,4,5,6}
set1.discard(2)
set1
...
# elements that are common to all of the sets.
...
# ISDISJOINT :This method reports whether another set contains this set.
# If the sets have null intersection then it's 'True'     
set1 = {1,2}
set2 = {1,2,4}
set3 = {5}
...
# ISSUUBSET : whether another set contains this set
...
# All the elements are that are in exactly one of the sets.

set1 = {1,2}
set2 = {1,2,4}
set1.symmetric_difference(set2)

# Union : union of sets,all elements
set1 = {1,2}
set2 = {1,2,4}
set1.union(set2)

# Update :union of itself and others
...
# the keys(), values() and items() methods return a dictionary view object which is
# always tided to original dict.
...
# Count : it takes an element and returnsno of times it occurs.

list.count(10)
 
list.count(2)

# extend : difference between append & extend
...
#  Placin word at the index 2
x.insert(2,'new')
x

# pop : "pop" off the last element of a list.
...
list1 = [1,2,3,4,'new',5,6,7,8]
list1.remove('new')
list1

# removes first '3' from the list
list2 = [1, 2, 3, 4, 3, 5, 6]
list2.remove(3)
list2

# reverse :  reverse() reverses a list.
...
# Assignment Tricks(upper case with string)

x = 'hello world'
y = x.upper()
y

# this will not work for list,first copy then insert to list.
...
# converting integer to binary and hexadecimal representation
...
# checking all letters in string are lower

str = 'Whereof one cannot speak, thereof one must be silent.'

str.islower()

# How many times does a letter show up in a string

str = 'bbdbsbsbsbfbfbghbbjbuabwbwbebrbffbxbxbsbsbdbdbfbgbgbr'
str.count('b')
...
# the full detail is in # Errors and exception handling in "function"
